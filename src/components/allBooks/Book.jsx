  ...
  return (
    ...
    <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
      <div className="flex items-center justify-between">
        <span className={`${featured ? "bg-green-500" :""} border-2 rounded-md cursor-pointer hover:bg-blue-500 hover:text-white px-3 py-1  text-black`} > Featured {featured}</span>
